...
parser.add_argument('--resume', type=str, default='logs/ResNet')
parser.add_argument('--logdir', type=str, default='logs/ResNet-avg')
...
if __name__ == "__main__":
    ...
    datadir = os.path.join(HOME, 'data/datasets/CIFAR100/numpy')
    dataset = CIFAR100(datadir, device)
