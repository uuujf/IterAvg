...
w_name = 'SGD-linear-bs{}-a0{}-eta{}-regu{}.npy'.format(bs, alpha0, eta, 0.0)
what_name = 'SGD-linear-bs{}-a0{}-gamma{}-regu{}.npy'.format(bs, alpha0, gamma, l2regu)
fig_name = 'SGD-linear-bs{}-a0{}-eta{}-regu{}.pdf'.format(bs, alpha0, eta, l2regu)
