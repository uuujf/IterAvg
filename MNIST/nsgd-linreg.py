...
w_name = 'linear-bs{}-alpha{}-eta{}-regu{}.npy'.format(bs, alpha, eta, 0.0)
what_name = 'linear-bs{}-alpha{}-gamma{}-regu{}.npy'.format(bs, alpha, gamma, l2regu)
fig_name = 'linear-bs{}-alpha{}-eta{}-regu{}.pdf'.format(bs, alpha, eta, l2regu)
...
if __name__ == "__main__":
    ...
    # generate path
    w = NSGDPath(model, dataset, eta, tau, 0, num_iters, bs)
    np.save(w_name, w)

    what = NSGDPath(model, dataset, gamma, tau_hat, l2regu, num_iters, bs)
